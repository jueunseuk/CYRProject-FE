...
export const getUserAttendanceData = async (userId) => {
    try {
        const response = await instance.get(`/attendance/data/${userId}`);
        return response;
    } catch (error) {
...
export const getUserAttendanceHisotry = async (userId) => {
    try {
        const response = await instance.get(`/attendance/history/${userId}`);
        return response;
    } catch (error) {
        const errorCode = error.response.code;

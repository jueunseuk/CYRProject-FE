            ...
            <S.ItemList>
                <S.ItemBox>
                    <S.VerticalWrapper $gap={"8px"} style={{width: "100px"}}>
                        <S.Icon src={posts} />
                        <S.Text $size={"13px"} $weight={"500"} >내가 작성한 글</S.Text>
                    </S.VerticalWrapper>
                ...
                <S.ItemBox>
                    <S.VerticalWrapper $gap={"8px"} style={{width: "100px"}}>
                        <S.Icon src={comments} />
                        <S.Text $size={"13px"} $weight={"500"} >내가 작성한 댓글</S.Text>
                    </S.VerticalWrapper>
                ...
                <S.ItemBox>
                    <S.VerticalWrapper $gap={"8px"} style={{width: "100px"}}>
                        ...
                        <S.Text $size={"13px"} $weight={"500"} >내가 공감한 글</S.Text>
                    </S.VerticalWrapper>
                ...
                <S.ItemBox>
                    <S.VerticalWrapper $gap={"8px"} style={{width: "100px"}}>
                        <S.Icon src={images} />
                        <S.Text $size={"13px"} $weight={"500"} >내가 올린 사진</S.Text>
                    </S.VerticalWrapper>
